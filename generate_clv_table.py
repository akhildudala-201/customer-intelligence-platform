...
def _print_summary(output: pd.DataFrame) -> None:
    """Prints a readable snapshot to the terminal — separate from
    generate_clv_table() itself so tests/other callers that just want the
    DataFrame aren't forced to also print."""
