"""
conftest.py (app/ml/tests/explainibility_interface_tests/)
...
than shared because app/ml/tests/explainibility_interface_tests/ is not
...
(app/ml/tests/explainibility_interface_tests/inference/conftest.py's
fixtures apply only to
app/ml/tests/explainibility_interface_tests/inference/, this file's
sys.path setup applies to everything under
app/ml/tests/explainibility_interface_tests/, api/ included).

Note: this only sets up sys.path -- it does NOT import anything from
app.ml.explainibility_interface. The source code this suite tests still
lives at app/ml/explainibility_interface/ (unchanged); only the tests
...
# This file lives at app/ml/tests/explainibility_interface_tests/conftest.py
# -- same depth from the repo root as the old location
# (app/ml/explainibility_interface/tests/conftest.py) had, so parents[4]
# is still correct: explainibility_interface_tests -> tests -> ml -> app -> repo root.
